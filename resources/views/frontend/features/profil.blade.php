        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <div class="d-flex align-itecenter">
                    <a href="{{ route('login') }}" class="btn btn-outline-light ms-2 fs-5 text-btn" id="btn-login">Masuk</a>
                    <a href="{{ route('register') }}" class="btn btn-light ms-3 fs-5 text-btn" id="btn-logout">Daftar</a>
                </div>
            </div>
        </div>
    </nav>
