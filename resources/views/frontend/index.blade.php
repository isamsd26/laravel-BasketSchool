...
<nav class="navbar navbar-expand-lg">
  <div class="container"> <a class="navbar-brand navbar-logo" href="#"> <img src="{{asset('frontend/images/Logo_AKJ_Basketball.png')}}" alt="logo" class="logo-1" width="50" height="50"> </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item"> <a class="nav-link" href="#" data-scroll-nav="4">Informasi Pendafataran</a> </li>
      </ul>
        ...
        <div class="col-md-8 col-sm-12">
          <div class="banner-text">
            ...
            <ul>
              ...
              <li><a class="btn btn-primary btn-xl text-uppercase" href="#">Tell Me More</a>
            </ul>
          </div>
        </div>
        <div class="col-md-4 col-sm-12"> <img src="{{asset('frontend/images/ipon.png')}}" class="img-fluid wow fadeInUp"/> </div>
      </div>
    </div>
  </div>
...
<div id="carouselExampleIndicators" class="container carousel slide my-5 py-3 bg-white" data-ride="carousel">
            ...
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="text-center">
                        <img src="{{asset('frontend/images/slider/b-1.jpg')}}" class="d-block mx-auto mb-3" style="height: 300px; width: 300px; object-fit: cover;" alt="Slide 1">
                ...
                <div class="col-md-4">
                    <div class="text-center">
                        <img src="{{asset('frontend/images/slider/b-2.jpg')}}" class="d-block mx-auto mb-3" style="height: 300px; width: 300px; object-fit: cover;" alt="Slide 2">
                ...
                <div class="col-md-4">
                    <div class="text-center">
                        <img src="{{asset('frontend/images/slider/b-3.jpg')}}" class="d-block mx-auto mb-3" style="height: 300px; width: 300px; object-fit: cover;" alt="Slide 3">
    ...
    <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev" style="left: 0;">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
    </a>
    <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next" style="right: 0;">
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script> <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js" integrity="sha384-smHYKdLADwkXOn1EmN1qk/HfnUcbVRZyYmZ4qpPea6sjB/pTJ0euyQp0Mk8ck+5T" crossorigin="anonymous"></script> 
